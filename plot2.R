...
## Plot 2
##########################################################################
##with(tdata, plot(Global_active_power, xaxt = "n",type="l"))
##axis(1, at=c(1,nrow(tdata)/2,nrow(tdata)),labels=c("Thu","Fri","Sat"))
##with(tdata, plot(DateTime, Global_active_power, type="l"))
